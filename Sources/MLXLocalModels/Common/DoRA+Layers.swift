...
internal class DoRALinear: Linear, LoRALayer {
    ...
    internal static func from(linear: Linear, rank: Int = 8, scale: Float = 20.0) -> LoRALayer {
...
/// ### See Also
/// - ``DoRALinear``
internal class QDoRALinear: QuantizedLinear, LoRALayer {
