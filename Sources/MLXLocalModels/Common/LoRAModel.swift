...
internal typealias LoRALinearLayers = [(Module, [String])]

internal protocol LoRAModel {
...
extension LoRAModel {
    ...
    internal func loraLinearLayers(_ count: Int) -> LoRALinearLayers {
...
internal protocol LoRALayer: Module {
