...
internal class Llama3RoPE: Module, OffsetLayer, ArrayOffsetLayer {
    let dims: Int
...
internal class ProportionalRoPE: Module, OffsetLayer, ArrayOffsetLayer {
    let dims: Int
    let traditional: Bool
    let rotatedDims: Int
    let _freqs: MLXArray?
...
internal class YarnRoPE: Module, OffsetLayer, ArrayOffsetLayer {
    let dimensions: Int
    let traditional: Bool
...
internal typealias RoPELayer = OffsetLayer & ArrayOffsetLayer
