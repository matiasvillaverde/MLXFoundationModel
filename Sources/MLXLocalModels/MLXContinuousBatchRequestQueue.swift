internal actor MLXContinuousBatchRequestQueue {
    private struct Waiter {
        let id: Int
        let continuation: CheckedContinuation<[MLXContinuousBatchQueuedRequest], any Error>
        let maxCount: Int
    }
    ...
    private var pending: [MLXContinuousBatchQueuedRequest] = []
    private var waiters: [Waiter] = []

    @discardableResult
    internal func enqueue(
        _ request: MLXContinuousBatchGenerationRequest
    ...
    ) -> MLXContinuousBatchQueuedRequest? {
    ...
    internal func nextBatch(
        maxCount: Int
    ) async throws -> [MLXContinuousBatchQueuedRequest] {
    ...
    private func drainBatch(maxCount: Int) -> [MLXContinuousBatchQueuedRequest] {
