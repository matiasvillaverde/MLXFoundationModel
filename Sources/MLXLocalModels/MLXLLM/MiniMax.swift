...
internal class MiniMaxModelInner: Module {
    let args: MiniMaxConfiguration
...
internal class MiniMaxModel: Module, LLMModel, KVCacheDimensionProvider {
    internal let vocabularySize: Int
    internal let kvHeads: [Int]

    internal let model: MiniMaxModelInner
    let configuration: MiniMaxConfiguration
    let modelType: String

    @ModuleInfo(key: "lm_head") var lmHead: Linear?

    internal init(_ args: MiniMaxConfiguration) {
...
internal struct MiniMaxConfiguration: Codable, Sendable {
