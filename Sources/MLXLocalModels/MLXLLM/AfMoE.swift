...
internal struct AfMoEConfiguration: Codable, Sendable {
...
internal class AfMoEModel: Module, LLMModel, KVCacheDimensionProvider {
    ...
    internal init(_ args: AfMoEConfiguration) {
