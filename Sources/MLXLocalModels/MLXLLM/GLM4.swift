...
internal class GLM4Model: Module, LLMModel, KVCacheDimensionProvider {
...
internal struct GLM4Configuration: Codable, Sendable {
    var hiddenSize: Int
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.attentionBias = try container.decode(
            Bool.self, forKey: Self.CodingKeys.attentionBias)
        ...
        self.ropeTraditional =
            try container.decodeIfPresent(
                Bool.self, forKey: Self.CodingKeys.ropeTraditional)
            ?? true
