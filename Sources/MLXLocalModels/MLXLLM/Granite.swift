...
private class Attention: Module {
    ...
    init(_ args: GraniteConfiguration) {
        self.args = args
...
internal struct GraniteConfiguration: Codable, Sendable {
    var hiddenSize: Int
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.ropeTheta = try container.decodeIfPresent(Float.self, forKey: .ropeTheta) ?? 10_000_000.0
