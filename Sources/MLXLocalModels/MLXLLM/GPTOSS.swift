...
internal struct GPTOSSConfiguration: Codable, Sendable {
    internal var modelType: String = "gpt_oss"
    internal var hiddenLayers: Int = 36
    internal var localExperts: Int = 128
    internal var expertsPerToken: Int = 4
    internal var vocabularySize: Int = 201088
    internal var rmsNormEps: Float = 1e-5
    internal var hiddenSize: Int = 2880
    internal var intermediateSize: Int = 2880
    internal var headDim: Int = 64
    internal var attentionHeads: Int = 64
    internal var kvHeads: Int = 8
    internal var slidingWindow: Int = 128
    internal var ropeTheta: Float = 150000
    internal var ropeScaling: [String: StringOrNumber]? = nil
    internal var layerTypes: [String]? = nil
...
class AttentionBlock: Module {
    ...
    internal init(_ config: GPTOSSConfiguration) {
...
internal class GPTOSSModelInner: Module {
...
internal class GPTOSSModel: Module, LLMModel, KVCacheDimensionProvider {
    internal let modelType: String
    internal let vocabularySize: Int
    internal let kvHeads: [Int]
    internal let model: GPTOSSModelInner
    ...
    internal func newCache(parameters: GenerateParameters?) -> [any KVCache] {
        var caches: [KVCache] = []
