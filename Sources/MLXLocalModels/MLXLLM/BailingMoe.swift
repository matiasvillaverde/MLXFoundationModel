...
internal struct BailingMoeConfiguration: Codable, Sendable {
...
internal class BailingMoeModelInner: Module {
...
internal class BailingMoeModel: Module, LLMModel, KVCacheDimensionProvider {
    internal let vocabularySize: Int
    internal let kvHeads: [Int]
    internal let model: BailingMoeModelInner
    let configuration: BailingMoeConfiguration
    @ModuleInfo(key: "lm_head") var lmHead: Linear?

    internal init(_ args: BailingMoeConfiguration) {
