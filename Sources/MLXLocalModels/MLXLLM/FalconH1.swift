...
internal struct FalconH1Configuration: Codable, Sendable {
...
internal class FalconH1ModelInner: Module {
...
internal class FalconH1Model: Module, LLMModel, KVCacheDimensionProvider {
    internal let vocabularySize: Int
    internal let kvHeads: [Int]

    internal let model: FalconH1ModelInner
    let configuration: FalconH1Configuration

    @ModuleInfo(key: "lm_head") var lmHead: Linear

    internal init(_ args: FalconH1Configuration) {
    ...
    internal func makeCache() -> [CacheList] {
