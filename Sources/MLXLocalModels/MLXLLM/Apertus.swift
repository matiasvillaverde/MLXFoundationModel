...
internal struct ApertusConfiguration: Codable, Sendable {
    ...
    internal init(from decoder: Swift.Decoder) throws {
...
private class ApertusMLP: Module {
    ...
    internal init(dim: Int, hiddenDim: Int) {
...
private class ApertusBlock: Module {
    ...
    internal init(_ args: ApertusConfiguration) {
...
internal class ApertusModel: Module, LLMModel, KVCacheDimensionProvider {
    ...
    @ModuleInfo(key: "lm_head") internal var lmHead: Linear?
