...
internal class Qwen3NextModelInner: Module {
...
internal class Qwen3NextModel: Module, LLMModel, KVCacheDimensionProvider {
    internal let vocabularySize: Int
    internal let kvHeads: [Int]

    internal let model: Qwen3NextModelInner
    let configuration: Qwen3NextConfiguration

    @ModuleInfo(key: "lm_head") var lmHead: Linear?

    internal init(_ args: Qwen3NextConfiguration) {
