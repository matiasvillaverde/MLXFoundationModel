...
internal final class Lille130mModelInner: Module {
...
internal final class Lille130mModel: Module, LLMModel, KVCacheDimensionProvider {
    internal let vocabularySize: Int
    internal let kvHeads: [Int]

    @ModuleInfo(key: "transformer") internal var transformer: Lille130mModelInner
    private let configuration: Lille130mConfiguration

    internal init(_ args: Lille130mConfiguration) {
...
internal struct Lille130mConfiguration: Codable, Sendable {
    internal var modelType: String
    internal var blockSize: Int
    internal var layerNormEps: Float
    internal var hiddenSize: Int  // n_embd
    internal var attentionHeads: Int  // n_head
    internal var kvHeads: Int  // n_kv_heads
    internal var hiddenLayers: Int  // n_layer
    internal var ropeTheta: Float
    internal var vocabularySize: Int
    internal var tieWordEmbeddings: Bool = true
