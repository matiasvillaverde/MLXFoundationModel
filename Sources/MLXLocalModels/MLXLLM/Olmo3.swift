...
internal class Olmo3ModelInner: Module {
...
internal class Olmo3Model: Module, LLMModel, KVCacheDimensionProvider {
    internal let vocabularySize: Int
    internal let kvHeads: [Int]

    internal let model: Olmo3ModelInner
    let args: Olmo3Configuration

    @ModuleInfo(key: "lm_head") var lmHead: Linear?

    internal init(_ args: Olmo3Configuration) {
...
internal struct Olmo3Configuration: Codable, Sendable {
    var hiddenSize: Int
