...
internal class GraniteMoeHybridModelInner: Module {
    let args: GraniteMoeHybridConfiguration
...
internal class GraniteMoeHybridModel: Module, LLMModel, KVCacheDimensionProvider {
    internal let vocabularySize: Int
    internal let kvHeads: [Int]
    let logitsScaling: Float

    internal let model: GraniteMoeHybridModelInner
    let configuration: GraniteMoeHybridConfiguration

    @ModuleInfo(key: "lm_head") var lmHead: Linear?

    internal init(_ args: GraniteMoeHybridConfiguration) {
