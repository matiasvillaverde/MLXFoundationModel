...
internal struct BaichuanM1Configuration: Codable, Sendable {
...
internal class BaichuanM1Model: Module, LLMModel, KVCacheDimensionProvider {
    ...
    public func newCache(parameters: GenerateParameters?) -> [KVCache] {
        model.layers.enumerated().map { i, _ in
