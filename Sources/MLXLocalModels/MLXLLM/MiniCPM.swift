...
internal final class MiniCPMModelInner: Module {
    ...
    internal init(_ args: MiniCPMConfiguration) {
...
internal final class MiniCPMModel: Module, LLMModel, KVCacheDimensionProvider {
    ...
    internal let model: MiniCPMModelInner
...
internal struct MiniCPMConfiguration: Codable, Sendable {
