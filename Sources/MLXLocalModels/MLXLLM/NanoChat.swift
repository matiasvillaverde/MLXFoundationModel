...
internal final class NanoChatModelInner: Module {
    let config: NanoChatConfiguration
...
internal final class NanoChatModel: Module, LLMModel, KVCacheDimensionProvider {
    ...
    @ModuleInfo(key: "transformer") internal var transformer: NanoChatModelInner
...
internal struct NanoChatConfiguration: Codable, Sendable {
